...
/*   Updated: 2022/01/28 23:46:18 by englot           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	static_ft_create_token(t_slist **tokenlist, int *i, int *pos, char *str)
{
	char	*tmp;
	t_slist	*node;
...
static int	static_split_tokens(t_slist **tokenlist, int *i, int *pos, char *str)
{
	if (*i > *pos)
	{
